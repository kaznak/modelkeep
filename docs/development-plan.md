...
| 23–24: phases/MVP acceptance | 下記のphase/MVP対応表、[Issue 0026](issues/0026-complete-qnap-gx10-acceptance-testing.md)、[Issue 0063: release acceptanceとrestore drillの分離](issues/0063-separate-qnap-release-acceptance-from-restore-drill.md) |
| 25: 将来拡張 | 下記の各候補Issue |
